...
export default function FileUpload({ onAnalysisComplete, setLoading }: FileUploadProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                <label htmlFor="resume" className="block text-sm font-medium text-gray-200">
            ...
            <div>
                <label htmlFor="job-description" className="block text-sm font-medium text-gray-200">
